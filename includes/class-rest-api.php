...
/**
 * Main Wampum_Forms_Rest_API Class.
 *
 * @since 1.1.0
 */
final class Wampum_Forms_Rest_API {

	/**
	 * Singleton
	 * @var   Wampum_Forms_Rest_API The one true Wampum_Forms_Rest_API
	 * @since 1.1.0
	 */
	private static $instance;

	/**
	 * Main Wampum_Forms_Rest_API Instance.
	 *
	 * Insures that only one instance of Wampum_Forms_Rest_API exists in memory at any one
	...
	public static function instance() {
		if ( ! isset( self::$instance ) ) {
			// Setup the setup
			self::$instance = new Wampum_Forms_Rest_API;
			// Methods
			self::$instance->setup();
		}
